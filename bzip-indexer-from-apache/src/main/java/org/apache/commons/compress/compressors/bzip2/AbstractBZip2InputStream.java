...
public abstract class AbstractBZip2InputStream extends CompressorInputStream
    ...
    protected boolean initAfterCreation = false;

    public AbstractBZip2InputStream(final InputStream in) throws IOException {
        this(in, false);
    }
     ...
     */
    public AbstractBZip2InputStream(final InputStream in, final boolean decompressConcatenated) throws IOException {
    ...
    private boolean complete() throws IOException {
        ...
        if (checkCrc && this.storedCombinedCRC != this.computedCombinedCRC) {
            throw new IOException("BZip2 CRC error");
        }
